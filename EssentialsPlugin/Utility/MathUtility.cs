namespace EssentialsPlugin.Utility
{
    ...
    public static class MathUtility
    {
        ...
        public static Vector3D GenerateRandomEdgeVector(Vector3D? playerPosition = null)
        {
            ...
            halfExtent = (halfExtent == 0 ? 10000f : 3000f);
            ...
            */
            ...
            //This is a hack. It's ugly but it should work.
            //I can't currently get clients to load in grids on creation, we'll spawn them in as close to the player as possible
            //this might cause problems, but meh
            ...
            else
            {
                playerPos = (Vector3D)playerPosition;
                vectorPosition = new Vector3D(GenerateRandomCoord(halfExtent), GenerateRandomCoord(halfExtent), GenerateRandomCoord(halfExtent));
                Vector3D.ClampToSphere(ref vectorPosition, playerRadius);
                vectorPosition += playerPos;
                positionSphere = new BoundingSphereD(vectorPosition, 50);
            }
