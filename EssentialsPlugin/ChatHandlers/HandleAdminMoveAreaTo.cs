...
{
	public class HandleAdminMoveAreaTo : ChatHandlerBase
	{
		public override string GetHelp()
		{
			return "This command allows you to move ships and stations from one area to another.  Usage: /admin move area to [SX] [SY] [SZ] [MX] [MY] [MZ] [RADIUS] where S is source and M is move amount which can positive or negative.";
		}
		public override string GetCommandText()
		{
			return "/admin move area to";
		}
